...
![CI](https://github.com/taktikorg/ipsum-cumque/workflows/CI/badge.svg)
[![NPM version](https://img.shields.io/npm/v/@taktikorg/ipsum-cumque.svg?style=flat)](https://www.npmjs.com/package/@taktikorg/ipsum-cumque)
...
`@taktikorg/ipsum-cumque` supports Fastify@3.
`@taktikorg/ipsum-cumque` [v1.x](https://github.com/taktikorg/ipsum-cumque/tree/1.x)
supports both Fastify@2.

## Install
```
npm i @taktikorg/ipsum-cumque
```
...
fastify.register(require('@taktikorg/ipsum-cumque'), {
  secret: 'supersecret'
})
...
const fastify = require('fastify')()
const jwt = require('@taktikorg/ipsum-cumque')
// secret as a string
...
Optionally you can define global default options that will be used by `@taktikorg/ipsum-cumque` API if you do not override them.
...
```
### fastify.jwt.cookie
For your convenience, `request.jwtVerify()` will look for the token in the cookies property of the decorated request. You must specify `cookieName`. Refer to the [cookie example](https://github.com/taktikorg/ipsum-cumque#example-using-cookie) to see sample usage and important caveats.
...
The following algorithms are currently supported by [fast-jwt](https://github.com/nearform/fast-jwt) that is internally used by `@taktikorg/ipsum-cumque`.
...
```js
const Fastify = require('fastify')
const fjwt = require('@taktikorg/ipsum-cumque')
...
```ts
import fastifyJwt, { FastifyJWTOptions } from '@taktikorg/ipsum-cumque'
```
...
```ts
// fastify-jwt.d.ts
import "@taktikorg/ipsum-cumque"

declare module "@taktikorg/ipsum-cumque" {
